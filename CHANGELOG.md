...
- **Swarm Observability**: Enhanced terminal dashboard with multi-node status aggregation and real-time mesh profit tracking.
- **Automated Mesh Joining**: Introduced the `-seed` flag for seamless node discovery and registration in the A2A mesh.
