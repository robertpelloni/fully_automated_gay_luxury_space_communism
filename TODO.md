...
## Immediate Tasks
- [ ] Integrate `sqlite-vec` for hyper-fast, local-first context matching. (Scaffolded and functional at Go-level in v1.0.0-alpha.25)
...
- [ ] Implement A2A Mesh for cross-host collaboration. (Topic Pub/Sub implemented in v1.0.0-alpha.30)
