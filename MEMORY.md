# Architectural Observations & Design Preferences
...
## Tech Stack
- Go for the core orchestrator.
- LLM-agnostic orchestration with failover.
- Multi-agent swarms (Planner, Implementer, Tester, Critic).
